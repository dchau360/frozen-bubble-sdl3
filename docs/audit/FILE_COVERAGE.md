...
| `server/game.c` | Tasks 3 and 4 | Task 3 complete; Task 4 client boundary | [Task 3 authorization review](subsystems/01-server-protocol.md#authorization-and-room-lifecycle) | Room/player allocation, authority, relay, stats, and lifecycle fully traced; BUG-003/005/009-011 and SEC-004 confirmed. |
...
| `server/net.c` | Tasks 3 and 9 | Task 3 complete; Task 9 portability boundary | [Task 3 length trace](subsystems/01-server-protocol.md#network-derived-length-and-index-trace) | Accept, ingress, output, signals, HTTP, fd guards, and teardown traced; BUG-002/004/007, SEC-002/005, and REL-003 confirmed without Task 3 runtime. |
