...
| `src/bubblegame_internal.h` | Task 5 | Complete | [Task 5 invariants](subsystems/03-gameplay.md#trust-boundaries-and-invariants) | Free/malus bubble state, movement, collision, wall reflection, chain physics, aggregate initialization, and both grid orientations reviewed. |
...
| `src/bubblegame_shooter.cpp` | Tasks 4-5 | Complete | [Task 5 board review](subsystems/03-gameplay.md#placement-collision-grouping-and-compression) | Launch/aim bounds, collision and free-cell BFS, next colors, peer placement consumer, chain landing, malus movement/stick, and high-delta behavior reviewed. |
