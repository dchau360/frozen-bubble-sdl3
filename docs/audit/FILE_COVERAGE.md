...
| `src/mainmenu_netpanel.cpp` | Tasks 4 and 6 | Task 4 network boundary complete; Task 6 UI/settings pending | [Task 4 execution contexts](subsystems/02-network-client-sync.md#execution-contexts-and-callback-ownership) | Focused async server-list and create/join state consumers traced; UI behavior remains Task 6. |
