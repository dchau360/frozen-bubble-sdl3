...
| IMP-005 | suspected | High benefit / Medium effort / Medium risk | Medium | Task 2; resolve in Tasks 5-7 (Task 4 slice dismissed) | Default-initialize state-bearing C++ members or prove construction-before-use invariants | [Task 4 disposition](subsystems/02-network-client-sync.md#dismissed-candidates) |
...
Task 2 alone confirmed no defect. Tasks 3 and 4 promoted only findings with
