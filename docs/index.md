...
- **Local multiplayer** for up to 5 players, with gamepad support.
...
<p align="center">
  <img src="screenshots/game-room.png" alt="A network game room with several players" width="600">
</p>
...
server is in the [`server/`](https://github.com/dchau360/frozen-bubble-sdl3/tree/main/server)
directory, and [SetupServer.md](https://github.com/dchau360/frozen-bubble-sdl3/blob/main/SetupServer.md)
...
and aren't tied to any account, so automatic kicks on report would just hand
...
Licensed under the [GNU General Public License v2](https://github.com/dchau360/frozen-bubble-sdl3/blob/main/COPYING),
the same licence as the original. The complete source is on
[GitHub](https://github.com/dchau360/frozen-bubble-sdl3).

Bug reports are welcome via
[GitHub Issues](https://github.com/dchau360/frozen-bubble-sdl3/issues).
